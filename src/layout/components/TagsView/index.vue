<template>
  ...
  >
    <div class="tabs-view-main">
      <div ref="navWrap" :class="{ 'tabs-card-scrollable': state.scrollable }" class="tabs-card">
        <span
...
import { TABS_ROUTES } from '@/constant/mutation-types'
import { RouteItem, useTabsViewStore } from '@/store/tabsView'
...
import { useGo } from '@/layout/components/TagsView/usePage'
...
const getDarkTheme = computed(() => osThemeRef.value === 'dark')
